        ...
        <div class="container">
            <div class="head_content d-flex">
                ...
                <div class="action col-2">
                    <a class="btn btn-danger" href="{{ route('admin.courses.show', $course) }}" title="Undo">
                        Undo
                    </a>
                </div>
            </div>
                ...
                <form action="{{ route('admin.courses.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                            ...
                            placeholder="Enter name course" value="{{ old('name', $course->name) }}">
                        @error('name')
                    ...
                    <div class="form-group">
                            ...
                            placeholder="Enter year course" value="{{ old('year', $course->year) }}">
                            @error('year')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                            ...
                            placeholder="Enter cfu course" value="{{ old('cfu', $course->cfu) }}">
                            @error('cfu')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                            ...
                            <textarea
                                ...
                                placeholder="Enter description course">{{ old('description', $course->description) }}</textarea>
                            @error('description')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
